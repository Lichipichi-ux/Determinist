...
const ChartSelector: React.FC = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full gap-2 md:gap-4 overflow-hidden animate-in fade-in duration-500">
      {/* Sidebar: Navigation - Mobile optimized */}
      <div className="w-full md:w-64 bg-white dark:bg-obsidian border border-obsidian/10 dark:border-white/10 rounded-sm flex flex-col shrink-0 shadow-sm overflow-hidden h-auto md:h-full">
        <div className="p-2 md:p-3 border-b border-obsidian/10 dark:border-white/10 bg-obsidian/5 dark:bg-white/5">
        ...
        <div className="p-3 md:p-4 flex-1 overflow-y-auto min-h-0 bg-seashell/10 dark:bg-transparent max-h-[200px] md:max-h-none">
      ...
      <div className="flex-1 bg-white dark:bg-obsidian border border-obsidian/10 dark:border-white/10 rounded-sm flex flex-col shadow-sm overflow-hidden">
        <div className="px-3 py-2 md:px-4 md:py-3 border-b border-obsidian/10 dark:border-white/10 flex flex-col md:flex-row md:items-center justify-between bg-white dark:bg-obsidian shrink-0 gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3 min-w-0 md:min-w-[280px]">
            ...
            <h2 className="text-xs md:text-xs font-black uppercase tracking-wider text-obsidian dark:text-seashell truncate">
              {activeBook.title}
            </h2>
          </div>
          ...
          <div className="flex-1 flex justify-center max-w-lg">
            <div className="relative w-full max-w-xs group">
              <Search className="absolute left-2.5 top-2 md:top-1.5 w-3.5 h-3.5 text-obsidian/30 dark:text-seashell/30 group-focus-within:text-denim transition-colors" />
              <input
                type="text"
                placeholder="Buscar cuenta inteligente..."
                value={filterText}
                onChange={e => setFilterText(e.target.value)}
                className="w-full pl-8 pr-2 py-2 md:py-1.5 bg-seashell/50 dark:bg-white/5 border border-obsidian/10 dark:border-white/10 rounded-sm text-sm md:text-[10px] focus:outline-none focus:border-denim focus:ring-1 focus:ring-denim/20 shadow-inner transition-all placeholder:text-obsidian/30 dark:placeholder:text-seashell/20"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-end min-w-[100px]">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 md:py-1.5 text-obsidian/50 dark:text-seashell/70 hover:text-red-600 dark:hover:text-red-400 transition-colors text-[9px] font-black uppercase tracking-widest bg-obsidian/5 dark:bg-white/5 rounded-sm active:scale-95 min-h-[40px] md:min-h-0"
            >
      ...
      <div className="hidden xl:flex w-96 bg-white dark:bg-obsidian border border-obsidian/10 dark:border-white/10 rounded-sm flex-col shrink-0 shadow-sm overflow-hidden">
